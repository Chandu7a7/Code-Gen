...
const CodeExplainer = () => {
  ...
  const FetchChart = async () => {
    ...
    try {
      ...
      const res = await axios.post("https://code-gen-y4vz.onrender.com/ai/get-response" , 
  ...
  const AddToFavourite = async () => {
    try {
      const res = await axios.post("https://code-gen-y4vz.onrender.com/user/addfavourite" , {code : code , response : response} , {withCredentials : true}) ; 
    ...
    <div className="ex-main">
      ...
      <header className="ex-header">
        <div className="ex-title">
          ...
          <p className='ex-by'>By CodeGenius</p>
        </div>
